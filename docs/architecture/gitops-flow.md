...
| `kubernetes/overlays/local` | Local lab overlay watched by Argo CD (image tag + ingress-nginx LoadBalancer Service) |
| `kubernetes/overlays/aws` | AWS overlay (not applied; no MetalLB / ingress-nginx Service patch) |
